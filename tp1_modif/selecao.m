function [POP, FX] = selecao(POP,FX,tamPOP)
    ...
    [POPelite, FXelite] = elite(POP,FX,tamELITE);
    [POPtorneio, FXtorneio] = torneio(POP,FX,tamPOP-tamELITE);
%     [POProleta, FXroleta] = roleta(POP,FX,tamPOP-tamELITE);
    POP = [POPelite; POPtorneio];
%     POP = [POPelite; POProleta];
    FX = [FXelite; FXtorneio];
%     FX = [FXelite; FXroleta];
end
